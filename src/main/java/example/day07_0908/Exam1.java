...
interface Calculator{ int plus(int x , int y ); } // 추상메소드이란? 구현{ }이 없는 메소드
...
public class Exam1 {
    ...
    public static void main(String[] args) {
        ...
        // < > : 제네릭이란? 인스턴스(객체) 생성할 떄 인스턴스(객체)내 멤버들의 타입 정의 한다.
        // List<Integer> : List 객체 1개 생성시 내부에 Integer 타입으로 항목 구성하겠다 뜻
        ...
        // [4-2] Supplier< T >  T : 입력없이결과반환값타입   , get() 메소드
        Supplier < Double > supplier =  ( ) -> 3.14; // return 생략시 { } 같이 생략
        System.out.println("supplier.get()  = " + supplier.get( ) );

        // [4-3] Consumer< T >  T : 입력받은값타입이고결과값없다. , accept( T ) 메소드
